...
df_split.to_csv('stored_data/patient_split_5_21.csv')
...
dump(scaler, 'stored_data/scaler_5_21.bin', compress=True)
...
with open('models/xgb_8_visits_5_21.pkl','wb') as f:
...
print(cutoff_prob)
dump(cutoff_prob, 'stored_data/xgb_8_visits_5_21_cutoff')
...
test_labels.to_csv('stored_data/5_21_model_test_output.csv')
...
df_test.to_csv('stored_data/test_df_5_21.csv')